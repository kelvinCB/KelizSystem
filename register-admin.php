...
if(isset($_POST['insert'])){
  ...
  $q = "INSERT INTO `colaborador`(`nombre`, `apellidos`, `correo`, `cargo`, `departamento`, `sexo`, `telefono`, `username`, `password`) VALUES ('$nombre', $apellidos, '$correo', '$cargo', '$departamento', '$sexo', '$telefono', '$username', '$password')";
            ...
            <div class="contact-container"> 
                <div class="well-well-sm">
                    <div class="panel-title text-center" id="title-container">
                        <h3 class="title">Registro Administrador</h3>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" method="POST" class="form-control" name="name" id="name"  placeholder="Ingrese su nombre" required="required"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                            <input type="text" method="POST" class="form-control" name="apellidos" id="name"  placeholder="Ingrese apellidos" required="required"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" method="POST" class="form-control" name="correo" id="email"  placeholder="Ingrese su correo" required="required"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" method="POST" class="form-control" name="cargo" id="name"  placeholder="Ingrese su cargo" required="required"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            ...
                                            <select id="subject" name="sexo" method="POST" class="form-control" required="required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" method="POST" name="telefono" id="name"  placeholder="Número de contacto" required="required"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" method="POST" name="password" id="password"  placeholder="Ingrese su contraseña" required="required"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                            <input type="password" class="form-control" method="POST" name="confirm" id="confirm"  placeholder="Confirme su contraseña" required="required"/>
                                        </div>
                                    </div>
                                </div>
